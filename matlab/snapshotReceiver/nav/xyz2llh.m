...
% or
% [phi, lambda, h] = xyz2llh( r )
% 
% Computes latitude, longitude and height (w.r.t. the WGS-84 ellipsoid) for
% given ECEF coordinates. 
% 
% Parameters:
% X,Y,Z........ x-, y- and z-component of the ECEF position vector
% r............ (3x1) ECEF position vector
% 
% Returns
% phi.......... latitude [rad]
